...
///
/// - Important: This may trigger nested framework fetches to evaluate descendants.
/// - Warning: Running this across many references can be network-intensive and may briefly show loading states.
///
/// - Parameters:
///   - reference: The reference to evaluate.
///   - filters: Active tag filters.
