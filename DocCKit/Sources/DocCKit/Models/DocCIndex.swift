...
public struct DocCIndex: Codable, Identifiable, Equatable, Hashable, Sendable {
    ...
    ///
    /// - Parameter interfaceLanguages: Interface-language entries keyed by language token.
    public init(interfaceLanguages: [String : [InterfaceLanguage]]) {
    ...
    public struct InterfaceLanguage: Codable, Identifiable, Equatable, Hashable, Sendable {
        ...
        public init(title: String, path: String?, type: String, children: [InterfaceLanguage]? = nil) {
            self.title = title
            self.path = path
            self.type = type
