...
public enum TechnologyTypes: Identifiable, Equatable, Sendable {
    ...
    public var url: URL {
        switch self {
        case .apple:
            return URL(string: DocCConstants.aDeveloperURLBase)!
...
extension [TechnologyTypes] {
    ...
    public var docCSites: [DocCSource] {
        compactMap { tech in
            switch tech {
...
public struct AppleTechnologies: Decodable, AppleDocumentation, Identifiable, Sendable {
    ...
    public struct FrameworkSection: Codable, Identifiable, AppleDocumentation, Sendable {
        ...
        ///
        /// - Parameters:
        ///   - languages: Supported interface languages for this framework.
        ///   - title: Framework display title.
        ///   - tags: Tag metadata for filtering and grouping.
        ...
        public struct Destination: Codable, Hashable, Sendable {
            ...
            /// Creates destination metadata for a framework entry.
            ///
            /// - Parameters:
            ///   - type: Destination type discriminator.
            ///   - isActive: Whether destination is currently active.
            ///   - identifier: Canonical destination identifier.
            public init(type: String, isActive: Bool, identifier: String) {
                self.type = type
