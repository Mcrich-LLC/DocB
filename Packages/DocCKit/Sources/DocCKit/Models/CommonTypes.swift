...
@CodableIgnoreInitializedProperties public struct ContentSection: Codable, Identifiable, Equatable, Hashable, Sendable {
    ...
    public struct Content: Codable, Identifiable, Equatable, Hashable, Sendable {
        ...
        public struct Tab: Codable, Equatable, Identifiable, Hashable, Sendable {
            ...
            /// Creates a tab content wrapper.
            ///
            /// - Parameters:
            ///   - content: Raw tab content blocks.
            ///   - title: Tab title shown in tab selectors.
...
public struct Variant: Codable, Equatable, Hashable, Sendable {
    ...
    public struct Trait: Codable, Equatable, Hashable, Sendable {
        ...
        public let interfaceLanguage: PreferredProgrammingLanguage
    }
}
...
public struct Reference: Codable, Hashable, Identifiable, Sendable {
    ...
    /// Optional human-readable DocC role heading from article metadata.
    ...
    public var docCSite: DocCSource?
    ...
    public var externalURL: URL? {
        ...
        guard let docCSite = docCSite else {
            guard urlString.contains(DocCConstants.aDeveloperURLBase) else {
                return URL(string: "\(DocCConstants.aDeveloperURLBase)\(urlString)")
            }
    ...
    public init(title: String? = nil, abstract: [ContentStruct]? = nil, identifier: String, kind: String? = nil, type: String, url: String? = nil, role: Role? = nil, roleHeading: String? = nil, fragments: [Fragment]? = nil, deprecated: Bool? = nil, beta: Bool? = nil, variants: [Variant]? = nil, images: [ImageStruct]? = nil, docCSite: DocCSource? = nil) {
        self.title = title
...
public enum Role: String, Codable, Equatable, Hashable, Sendable {
    ...
    public var readableAccentColor: Color? {
        switch self {
        case .article:
            nil
        case .sampleCode:
